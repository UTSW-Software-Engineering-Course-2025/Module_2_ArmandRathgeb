...
class VAE(tf.keras.Model):
    ...
    def __init__(self, 
        ...
        # 
        self.encoder = Encoder(n_latent_dims)
    ...
    def call(self, inputs, training=None):
        ...
        z_mean, z_logvar = self.encoder(inputs, training=training) # Sample the mean and variance from an encoded distribution
